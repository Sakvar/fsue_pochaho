...
- В Telegram автоматически включается режим Mini App (SDK инициализируется, окно разворачивается, подхватываются `themeParams`, включается haptic feedback на выборе решения).
